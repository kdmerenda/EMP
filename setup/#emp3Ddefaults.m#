...
inputs.exefile = 'emp3d-fork';
inputs.exedir = '/home/kmerenda/simelve/emp3/';

inputs.submitjob = 0;  % set to zero just to test setup
...
inputs.sourcealt = 5e3;
inputs.chlength = 5e3;  % channel length for IC, ignored by CG
inputs.taur = 10e-6;
inputs.tauf = 100e-6;
...
inputs.Bmag = [-13984 725 18891] * 1e-9;
